...
\begin{center}
\begin{tabular}{cc}
\includegraphics[height=4cm]{png/DisqueGray} &
\includegraphics[height=3.5cm]{png/CodeurGray} \\
...
\begin{center}
\includegraphics[width=.95\textwidth]{png/DisqueIncremental}
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width=\textwidth]{png/ChronogrammeIncremental}
\end{center}
\end{minipage} \hfill
\begin{minipage}[c]{.45\linewidth}
\begin{center}
